...
public class OAuthAccessTokenActivity extends Activity {
	...
	protected void onResume() {
        ...
        final String authorizationUrl = new GoogleAuthorizationRequestUrl(OAuth2ClientCredentials.CLIENT_ID, OAuth2ClientCredentials.REDIRECT_URI, OAuth2ClientCredentials.SCOPE).build();
