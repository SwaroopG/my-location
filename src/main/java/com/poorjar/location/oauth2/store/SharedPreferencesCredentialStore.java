package com.poorjar.location.oauth2.store;
...
public class SharedPreferencesCredentialStore implements CredentialStore
{
    ...
    public SharedPreferencesCredentialStore(final SharedPreferences prefs)
    {
        this.prefs = prefs;
    }
    ...
    @Override
    public void write(final AccessTokenResponse accessTokenResponse)
    {
