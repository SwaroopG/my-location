...
public class LatitudeApiSample extends Activity {
	...
	private void performApiCall() {
		try {
			...
			final GoogleAccessProtectedResource accessProtectedResource = new GoogleAccessProtectedResource(accessTokenResponse.accessToken,
			        transport,
			        jsonFactory,
	...
	private String convertLocationToString(
			final LatitudeCurrentlocationResourceJson currentLocation) {
		...
		final String locationAsString = "Current location : " + currentLocation.get("latitude") + " - " + currentLocation.get("longitude") + " at " + df.format(d);
