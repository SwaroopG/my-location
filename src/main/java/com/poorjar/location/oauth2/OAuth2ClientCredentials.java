...
/**
 * OAuth 2 credentials found in the <a href="https://code.google.com/apis/console"> Google apis console</a>.
 */
public class OAuth2ClientCredentials
{
    /** Value of the "Client ID" shown under "Client ID for installed applications". */
    public static final String CLIENT_ID = "842729432457.apps.googleusercontent.com";
    ...
    /** Latitude API key */
    public static final String API_KEY = "AIzaSyDojoEfOebzYu5MjIuvO0rKV2nsUWbIxLA";
